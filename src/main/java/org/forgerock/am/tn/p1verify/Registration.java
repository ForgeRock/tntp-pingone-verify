...
@Node.Metadata(
		outcomeProvider = Registration.RegistrationOutcomeProvider.class, 
		configClass = Registration.Config.class, 
		tags = {"marketplace", "trustnetwork" })
public class Registration implements Node {
	...
	private final String loggerPrefix = "[PingOne Verify Registration Node]" + PingOneVerifyPlugin.logAppender;
	
	public static final String BUNDLE = Registration.class.getName();
	...
	public interface Config {
		...
		@Attribute(order = 800)
		default boolean preserveAttributes() {
			return true;
		}
	 ...
	 */
	@Inject
	public Registration(@Assisted Config config, @Assisted Realm realm, CoreWrapper coreWrapper) {
	...
	public static class RegistrationOutcomeProvider implements OutcomeProvider {
		@Override
		public List<Outcome> getOutcomes(PreferredLocales locales, JsonValue nodeAttributes) {
			ResourceBundle bundle = locales.getBundleInPreferredLocale(Registration.BUNDLE,
